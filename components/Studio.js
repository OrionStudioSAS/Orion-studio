        ...
        <div className="studio__right content-mid orion">
          <div className="orbital-system">
            ...
            <div className="rotating _2">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/planet2.png" alt="" className="planet" />
            </div>
            <div className="rotating _3">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/planet3.png" alt="" className="planet" />
            </div>
            <div className="rotating _4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/planet4.png" alt="" className="planet" />
            </div>
            <div className="rotating _5">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/planet5.png" alt="" className="planet" />
            </div>
            <div className="rotating _6">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/images/planet6.png" alt="" className="planet" />
            </div>
